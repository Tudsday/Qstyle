...
/*
# @copyright: 分享工作室 Yuan 2026 04 01
# @filename; Qstyle.class.php
# @version: Qstyle 8.1.0;
*/
class Qstyle{
	public $templates_dir         = array('./Data/default/');       //模板路径,支持数组叠代多层目录,最后面的优先搜索;
	...
	protected $PHPnew = 'Qstyle 8.1.0';
    protected $cssname = ''; // css文件名, 用于静态文件解析.
